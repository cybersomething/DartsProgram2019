...
int main()
{
	...
	int playeroneID = 0; //variable to temporarily hold player one's ID
	int playertwoID = 1; //variable to temporarily hold player two's ID
	...
	player playerone(name1, success_rate1, playeroneID); //creates an instance for player one and stores player one's information into this.
	player playertwo(name2, success_rate2, playertwoID); //creates an instance for player two and stores player two's information into this.
